...
from app import app_instance, clean_expired_sessions, gst_sessions, validate_gstin
...
class TestGSTINValidation:
    ...
    def test_valid_gstin(self):
        ...
        valid_gstins = ["01ABCDE0123F1Z5", "27ABCDE0123F1Z5", "09ABCDE0123F1Z5"]
    ...
    def test_validate_gstin_endpoint(self, client):
        ...
        # Test missing GSTIN
        response = client.post(
            "/validate-gstin", json={}, content_type="application/json"
        )
...
class TestCaptchaEndpoint:
    ...
    def test_get_captcha_success(self, mock_session_class, client):
        ...
        mock_response.content = (
            b"fake_captcha_data" * 20
        )  # Make it longer than 100 bytes
...
class TestGSTDetailsEndpoint:
    ...
    def test_get_gst_details_missing_fields(self, client):
        ...
        response = client.post("/gst-details", json={}, content_type="application/json")
        ...
        response = client.post(
            "/gst-details",
            json={"session_id": self.session_id, "gstin": "01ABCDE0123F1Z5"},
            content_type="application/json",
        )
...
class TestGSTServicesEndpoint:
    ...
    def test_get_gst_services_success(self, mock_session_class, client):
        ...
        mock_response.json.return_value = {
            "bzsdtls": [
                ...
                {"saccd": "00440189", "sdes": "CARGO HANDLING SERVICES"},
            ]
        }
        ...
        assert (
            first_activity["service_description"]
    ...
    def test_get_gst_services_missing_gstin(self, client):
        ...
        response = client.post(
            "/gst-services", json={}, content_type="application/json"
        )
